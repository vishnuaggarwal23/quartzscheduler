...
import static com.vishnu.aggarwal.quartz.core.enums.JobType.API;
...
public class ThymeleafUrlMapping extends UrlMapping.Admin {
    ...
    public static String createApiJobUri() {
        return format("%s%s%s%s%s%s%s", Web.BASE_URI, Web.Quartz.BASE_URI, Web.Quartz.CREATE_JOB, ApplicationConstants.QUESTION_MARK, ApplicationConstants.TYPE, ApplicationConstants.EQUAL_TO, API);
    }

    public static String createSimpleTriggerUri() {
        return format("%s%s%s%s%s%s%s", Web.BASE_URI, Web.Quartz.BASE_URI, Web.Quartz.CREATE_TRIGGER, ApplicationConstants.QUESTION_MARK, ApplicationConstants.TYPE, ApplicationConstants.EQUAL_TO, SIMPLE);
    }

    public static String createCronTriggerUri() {
        return format("%s%s%s%s%s%s%s", Web.BASE_URI, Web.Quartz.BASE_URI, Web.Quartz.CREATE_TRIGGER, ApplicationConstants.QUESTION_MARK, ApplicationConstants.TYPE, ApplicationConstants.EQUAL_TO, CRON);
    }
