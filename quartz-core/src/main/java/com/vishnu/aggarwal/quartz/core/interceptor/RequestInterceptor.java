package com.vishnu.aggarwal.quartz.core.interceptor;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.vishnu.aggarwal.quartz.core.constants.ApplicationConstants;
...
//        request.setAttribute(CUSTOM_REQUEST_ID, ID);
        ...
        log.info("*************[PREHANDLE Request Interceptor ID " + request.getAttribute(ApplicationConstants.CUSTOM_REQUEST_ID) + "] Request Logging ***************\n " + convertMapToJsonString(data) + "\n");
    ...
    public void afterCompletion(HttpServletRequest request, HttpServletResponse response, Object handler, Exception ex) {
        ...
        log.info("*************************************************************************************");
        request.removeAttribute(ApplicationConstants.CUSTOM_REQUEST_ID);
    }
}
