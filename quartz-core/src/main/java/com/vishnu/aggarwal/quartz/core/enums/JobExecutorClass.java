...
public enum JobExecutorClass {
     ...
     */
    GET_API_EXECUTOR("com.vishnu.aggarwal.quartz.rest.util.quartz.ApiGetRequestUtil", "ApiGetRequestUtil", GET),
    /**
     * Post api executor job executor class.
     */
    POST_API_EXECUTOR("com.vishnu.aggarwal.quartz.rest.util.quartz.ApiPostRequestUtil", "ApiPostRequestUtil", POST),

    /**
     * Delete api executor job executor class.
     */
    DELETE_API_EXECUTOR("com.vishnu.aggarwal.quartz.rest.util.quartz.ApiDeleteRequestUtil", "ApiDeleteRequestUtil", DELETE);
